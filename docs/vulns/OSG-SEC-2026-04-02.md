...
OpenBao is an open source identity-based secrets management system. A reflected cross-site scripting (XSS) vulnerability (CVE-2026-33758) exists in OpenBao.  In addition, a related vulnerability (CVE-2026-33757) >
